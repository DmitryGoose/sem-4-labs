...
export class MainPage {
    constructor(parent) {
        this.parent = parent;
        this.money3D = null;  // экземпляр 3D-сцены
    }
    ...
    getHTML() {
        return `
            <div class="container">
                ...
                <!-- 3D-модель пачки купюр -->
                <div id="money-container" style="width: 100%; height: 400px; margin-bottom: 30px;"></div>

                <div class="d-flex justify-content-between align-items-center mb-3">
                    <input type="text" id="search-input" class="form-control w-25" placeholder="Фильтр по названию...">
                    <button id="add-button" class="btn btn-success">➕ Добавить</button>
                </div>
    ...
    clickCard(e) {
        ...
        this.destroy();  // останавливаем 3D-сцену перед переходом
    ...
    render() {
        // Если уже есть сцена – сначала выключаем её
        this.destroy();
